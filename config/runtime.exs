...
#
#     PHX_SERVER=true bin/live_quiz start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :live_quiz, LiveQuizWeb.Endpoint, server: true
end
  ...
  config :live_quiz, LiveQuizWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/live_quiz_web/router\.ex$"E,
        ~r"lib/live_quiz_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
